...
(function () {
  ...
  // Canonical order — mirrors /tools/ index page.
  ...
  function render() {
    ...
    label.innerHTML = '<span>All Tools</span><a href="/tools/" class="tool-nav__label-link" aria-label="Open tools index">Index</a>';
