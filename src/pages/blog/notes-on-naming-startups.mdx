...
title: 'Notes on Company Naming'
date: '2026-05-01'
description: 'Where company naming is going in the age of AI and agents, and what earlier naming eras reveal.'
heroImage: '/blog/notes-on-naming-startups/canoe-manned-by-voyageurs-passing-waterfall.jpg'
heroAlt: 'Canoe manned by voyageurs passing a waterfall'
heroTitle: 'Canoe Manned by Voyageurs Passing a Waterfall'
heroArtist: 'Frances Anne Hopkins'
heroYear: '1869'
heroCreditUrl: 'https://commons.wikimedia.org/wiki/File:%E2%80%9CCanoe_Manned_by_Voyageurs_Passing_a_Waterfall%E2%80%9D_by_Frances_Anne_Hopkins_%C2%AB_Voyageurs_en_canot_passant_devant_une_cascade_%C2%BB_par_Frances_Anne_Hopkins_%2841994620880%29.jpg#/media/File:%E2%80%9CCanoe_Manned_by_Voyageurs_Passing_a_Waterfall%E2%80%9D_by_Frances_Anne_Hopkins_%C2%AB_Voyageurs_en_canot_passant_devant_une_cascade_%C2%BB_par_Frances_Anne_Hopkins_(41994620880).jpg'
heroAspectRatio: '2400 / 1195'
toc:
  - label: 'Intro'
    href: '#intro'
  - label: '1500s-1700s'
    href: '#1-1500s-1700s--chartered-mercantile-names'
  - label: '1800s infrastructure'
    href: '#2-mid-to-late-1800s--infrastructural-territorial-names'
  - label: 'Consumer goods'
    href: '#3-1880s-1930s--branded-consumer-goods'
  - label: 'Corporate scale'
    href: '#4-late-1800s-1960s--corporate-scale-and-administration'
  - label: 'Software compression'
    href: '#5-late-1990s-2010s--software-compression'
  - label: 'Counter-currents'
    href: '#6-2000s-2020s--counter-currents'
  - label: 'AI era'
    href: '#7-2020s-onward--the-ai-era-tbd'
  - label: 'Meta-game'
    href: '#the-meta-game'
  - label: 'Naming now'
    href: '#what-this-means-if-youre-naming-a-company'
---

<section id="intro" className="post-intro">

AI is going to make company naming weird again.

For years, company names have been compressed by the same bottleneck: trademarks, domains, app icons, and the consensus that short, abstract, friendly words feel "tech." That's how every category slowly fills with names that are correct, available, and forgettable.
...
So the question is not just what makes a good company name. The better question is: what will a name need to prove in the next era?
...
I've named a few companies ([Highlight](http://highlight.xyz), [Vie](http://vie.game)), and each time I've gone through the same loop: brainstorm, check domains, test out loud, commit. I've also worked with [David Placek](https://www.linkedin.com/in/david-placek-lexicon/), the legendary founder of Lexicon Branding — the firm behind BlackBerry, Pentium, PowerBook, Sonos, Swiffer, Impossible Foods, Azure, and Vercel, among thousands of others.
...
If you’re naming a company, knowing which kind of era you're in is the meta-game.
